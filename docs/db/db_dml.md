...
```text
1. RouteDetail -> View Similar Routes QA 지원
2. RouteDetail -> View History QA 지원
3. 기존 routes 테이블에 route_cluster_id 연결
4. route_clusters / activities 기반 조회 endpoint 검증
```

### Schema DDL

Supabase SQL Editor 또는 관리자 DB 세션에서 실행한다.
